...
function SignInContent() {
  ...
  useEffect(() => {
    ...
    if (oauth === 'google') {
      ...
      // Automatically trigger Google OAuth sign-in
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-3 text-glow">
            {isAutoTrigger ? 'Signing you in...' : 'Welcome to Lovelock'}
          </h1>

          <p className="text-gray-300 text-lg">
            {isAutoTrigger
              ? 'Please wait while we redirect you to Google...'
              : 'Sign in to unlock your cosmic insights'
            }
          </p>
        ...
        {/* Fallback for manual Google sign-in if auto-trigger fails */}
        {isAutoTrigger && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <p className="text-gray-400 text-sm mb-4">
              Having trouble? Click the Google button above to sign in manually.
            </p>
          </motion.div>
        )}
      </motion.div>
